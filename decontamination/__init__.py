...
from .jit import get_max_threads, get_max_threads_per_block, get_num_threads, set_num_threads
...
__all__ = [
    ...
    'get_max_threads', 'get_max_threads_per_block', 'get_num_threads', 'set_num_threads',
