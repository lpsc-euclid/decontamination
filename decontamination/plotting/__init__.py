...
def get_full_sky(nside: int, fill_value, dtype: typing.Type[typing.Union[np.float32, np.float64, float, np.int32, np.int64, int, bool]] = np.float32, use_zarr: bool = True) -> np.ndarray:
    ...
    if not use_zarr or zarr is None:
