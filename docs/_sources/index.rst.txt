...
This software is a toolbox for cosmology analysis with three main purposes: handling HEALPix masks (a.k.a. maps,
...
correlation functions (2PCF) decontaminated from the systematics.
